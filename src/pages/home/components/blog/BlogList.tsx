...
{ blogList && blogList.length > 0 && (
            <><div className="flex flex-col flex-wrap justify-center gap-4 px-5 my-auto h-4/5 lg:flex lg:flex-row">
                    <div className="lg:w-2/4 sm:w-[75%] mx-auto">
                    ...
                    {blogList?.map((item: PostModel) => (
                        <div className="h-full mx-auto lg:w-1/4 sm:w-full">
